...
| Prompt and daily memory files        | [Prompt and memory boundaries](configuration/prompts-memory.md)                        | Prompt service, workspace commands, native regressions, and renderer port/page tests                    |
