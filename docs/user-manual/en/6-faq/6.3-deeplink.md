...
The repository includes a deep link generator as [`deplink.html`](https://github.com/fy-agent/fyagent/blob/main/deplink.html). Download that file from the repository and open it locally in a browser; no separate hosted generator is established by this repository.
