...
- Right-click the FyAgent icon in the system tray
...
If Claude Code prompts you to **log in** or shows an onboarding wizard on first launch, enable the "Skip Claude Code first-run confirmation" option in FyAgent:

1. Open FyAgent "Settings > General"
...
- [Add more providers](../3-providers/3.1-add.md) - Configure multiple providers for easy switching
- [Configure MCP servers](../4-extensions/4.1-mcp.md) - Extend AI tool capabilities
- [Set up system prompts](../4-extensions/4.2-prompts.md) - Customize AI behavior
- [Enable proxy service](../5-proxy/5.1-service.md) - Monitor usage and enable automatic failover
...
If your provider is not in the preset list, select "Custom" for manual configuration. See [Add Provider](../3-providers/3.1-add.md) for configuration format details.
