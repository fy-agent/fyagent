...
FyAgent provides a smart backfill protection mechanism to ensure your manual modifications are not lost.
...
```
fyagent://import/prompt?data=<base64-encoded preset>
```
