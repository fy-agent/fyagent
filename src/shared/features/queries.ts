...
const scope = "fyagent";
const changeJobsKey = [scope, "change-plans", "job"] as const;
...
export const featureKeys = {
  ...
  agentAuthObservation: (agentId: AgentCatalogId) =>
    [scope, "agents", agentId, "auth-observation"] as const,
  agentInstallReadiness: (agentId: AgentCatalogId) =>
    [scope, "agents", agentId, "install-readiness"] as const,
  agentInstallationInventory: (agentId: AgentCatalogId) =>
    [scope, "agents", agentId, "installation-inventory"] as const,
  recoverableChangeJobs: [scope, "change-plans", "recoverable"] as const,
  ...
  openCodeModelSnapshot: [scope, "opencode", "model-snapshot"] as const,
  skills: [scope, "skills", "installed"] as const,
  skillBackups: [scope, "skills", "backups"] as const,
  skillDiscovery: [scope, "skills", "discovery"] as const,
  skillUnmanaged: [scope, "skills", "unmanaged"] as const,
  skillUpdates: [scope, "skills", "updates"] as const,
  mcp: [scope, "mcp"] as const,
  prompts: (app: PromptAppId) => [scope, "prompts", app, "list"] as const,
  promptLiveFile: (app: PromptAppId) =>
    [scope, "prompts", app, "live-file"] as const,
  memoryDocument: (id: MemoryDocumentId) =>
    [scope, "memory", "document", id] as const,
  hermesMemoryLimits: [scope, "memory", "hermes-limits"] as const,
  dailyMemoryFiles: [scope, "memory", "daily", "list"] as const,
  dailyMemoryFile: (filename: string) =>
    [scope, "memory", "daily", "file", filename] as const,
