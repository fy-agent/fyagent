...
#[cfg(test)]
mod tests {
    use super::super::transform_codex_responses_xai_sanitize::create_xai_native_responses_sse_stream;
    use super::*;
    use bytes::Bytes;
    use futures::stream;
    ...
    #[tokio::test]
    async fn xai_sse_stream_restores_function_call_events_and_passes_others_through() {
        let map = namespace_restore_map(&namespace_request());
