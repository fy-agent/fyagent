...
explicit discard / expiry
  ...
  -> prepare/confirm independent candidate-delete and candidate-missing slots
  -> delete -> durable {deleteDisposition, backendCompletedAt, deleteAppliedCas}
  -> independently authorized Validate missing readback
