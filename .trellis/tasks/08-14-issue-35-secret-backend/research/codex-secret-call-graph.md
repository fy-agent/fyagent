...
| --- | --- | --- | --- |
| `activationCleanup` | prepare active-read and old-delete authorization before a #41-held Provider lease; after delete, obtain a separate fresh-missing-readback authorization/checkpoint before terminal state; consume exact recovery CAS under lease | #41 | structural scrub/delete/readback crash matrix, distinct authorization receipts and stale-CAS effect-none |
