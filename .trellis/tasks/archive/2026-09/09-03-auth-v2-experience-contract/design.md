...
复用 V2 navigation、FeaturePorts、TanStack Query、FeatureTabs/CatalogMasterDetail/InlineNotice/Button/Dialog primitives；新增 shared/features/managed-auth 与 shared/platform/browser/tauri adapter，页面只做组合。先定义 UI view model 与 wire v1，不在页面解析 raw payload。
