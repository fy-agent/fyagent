# 历史文本（工作站路径已匿名化）：evidence/native-continuation/writer-rework/verify_native_writers.py

此文件为历史源码或运行证据，经工作站用户目录语义匿名化后以 Markdown 保存，不是运行入口。归档过程未执行其中内容。**本提交不再声称代码块与原稿字节相同。** 原稿可从来源提交 `6e6a3b3870a047874354f8f685b163622325331b` 的 `.trellis/tasks/archive/2026-09/09-22-session-cross-device-recovery/evidence/native-continuation/writer-rework/verify_native_writers.py` 恢复。

原路径、原稿与提交稿的哈希及恢复来源见[归档路径映射](research/archive-path-map.json)。

- 原稿字节数：11845
- 原稿 SHA-256：`1b61f0c4e25e108d63ae6d1c76732bd9774d008d46008e623ed6da31fbd0cf04`
- 匿名化载荷字节数：11842
- 匿名化载荷 SHA-256：`1158d1474c29888d1d741ea5c0d794f1df43e3c827436868688101745d5d90e8`
...
ROOT.mkdir()
OPENCODE = '/Users/<username>/.opencode/bin/opencode'
HERMES = '/Users/<username>/.local/bin/hermes'
HERMES_SOURCE = '/Users/<username>/.hermes/hermes-agent'
