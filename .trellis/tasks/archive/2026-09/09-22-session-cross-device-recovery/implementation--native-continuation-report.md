...
- OpenCode **1.18.30**, installed `/Users/<username>/.opencode/bin/opencode`.
- Hermes **v0.20.5 (2026.8.19)**, upstream `f293e720`, local `987064caa4f8845f605ac7346fed5b72fddfb21c` (+1 carried commit), installed official package/venv under `/Users/<username>/.hermes/hermes-agent`.
...
- Reproduction scripts: `probe_opencode.py`, `probe_hermes_sdk.py` in that evidence directory. Scripts expect the isolated environment JSON prepared in scratch; rerun instructions below. Full scratch is `/Users/<username>/Documents/Codex/2026-09-22/new-chat/work/native-continuation`.
