...
```text
rtk proxy mise exec -- pnpm exec playwright test --config /Users/serendipity/Documents/Codex/2026-09-22/new-chat/work/browser-final-review/screenshots.config.ts
```
