...
| Readiness, inventory, opaque targets, install/update/launch jobs, rollback and recovery | [External Agent Lifecycle](./external-agent-lifecycle.md) |
| Product release sources, exact npm admission, artifact bounds and closed desktop identity | [External Agent Product Sources](./external-agent-sources.md) |
