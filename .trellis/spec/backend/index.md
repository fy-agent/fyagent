...
| [Unified Change Plan](./unified-change-plan.md)                           | Side-effect-free v2 Plans for protected operations, canonical identity/baseline digests, additive v16 single-ledger persistence, fenced background jobs, readback reconciliation, secret capability gates, and renderer routing.        |
...
| [Deep-Link Import Security](./deeplink-import-security.md)                | Untrusted `fyagent://v1/import` validation, closed credential-free Codex draft-to-Plan routing, zero-write navigation, and legacy non-Codex confirmation boundaries.                                                                |
