...
| [Rust Host Modular Boundaries](./modular-boundaries.md)                   | Modular-monolith visibility/dependency rules, command ownership, private Provider/Skill/Proxy/Codex subdomains, and executable architecture checks. |
...
| [Unified Change Plan](./unified-change-plan.md)                           | Existing-Codex-Provider switch plan identity, schema-v20 ledger, memory-only secret proof, one-time admission, writer ownership, readback, and no-replay recovery.                              |
