...
| [Shurufa Companion Serial and Agent Bridge](./shurufa-companion.md)       | Native-owned COM pump, `shurufa_companion_*` commands, `VKEY_ASR/1` exactly-once admission, reuse of existing shurufa Agent/`enigo`, and ACL/handler registration.                                                                         |
