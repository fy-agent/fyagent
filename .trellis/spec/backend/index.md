...
| [GitHub Release Workflow](./github-release-workflow.md)                   | Exact authority-branch HEAD/tag/successful-push-CI identity, full preflight/formal topology, single DMG `notarytool info` poll, asset transaction, attestation, and public Release.              |
