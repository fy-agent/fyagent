...
| [V2 Skills and MCP Feature Contract](./v2-skills-mcp.md)                   | Six catalog-ordered V2 Skill and MCP targets, paginated Skill discovery (`discoverPage`), shared `.fy-feature-discovery-scroll` / `FeaturePagination`, leftover full-list discover, Qoder/TRAE/WorkBuddy live MCP files, secret handling, and responsive UI. |
