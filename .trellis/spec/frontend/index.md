...
| [V2 Skills and MCP Feature Contract](./v2-skills-mcp.md)                   | Seven catalog-ordered V2 Skill and MCP targets, disk-observed installed Skills, Skill 市场 discovery (`searchSkillHub` with growing upstream `limit`, no 仓库 / skills.sh tab), Skills page-level discovery scroll, leftover Gemini/Hermes round-trip, Qoder/TRAE/WorkBuddy live MCP files, secret handling, and responsive UI. |
