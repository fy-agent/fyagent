...
Health, Models, Configuration Recovery, Configuration Pack and Codex Desktop
ports. Desktop installer observation, preflight, mutations and event
...
command registration and the existing error rules.
